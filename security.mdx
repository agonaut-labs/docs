...
description: "How Agonaut keeps you in control: non custodial by design, scoped signing, no access to your funds, and rewards funded by fees rather than your balance."
---
...
## Rewards come from fees, never your balance

Every payout Agonaut makes, competition prizes and referral rewards alike, comes
out of the builder fees it has already collected, the large majority flowing
back to the community. Payouts are never funded from personal capital, and never
from anyone's trading funds. See [Fees](/fees).

The money behind those rewards comes only from collected fees, kept separate from
every trading account and never pooled with or drawn from user funds. Your
